<?php
  include './Pages/Global/config.php';
  include './Pages/Global/conexion.php';
  ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
            ...
            <div class="carousel-item active">
                ...
                <div class="card-container">
                    ...
                    <div class="card" style="width: 15%">
                        <img src="<?php echo $servicio['img_servicio']; ?>" class="card-img-top" alt="Tienda" />
                        <div class="card-body">
            ...
            <div class="carousel-item">
                <div class="card" style="width: 40%">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $servicio['nombre_servicio']; ?></h5>
                        <p class="card-text">
                        <?php echo $servicio['desc_servicio']; ?>
                        </p>
    ...
    <div class="container" id="contactanos">
        ...
        <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Cosas para decir cosas" rows="3"></textarea>
        </div>
    </div>
